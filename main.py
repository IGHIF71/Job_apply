...
class EasyApply:
    ...
    def clickeasyapply(self):
        time.sleep(1)
        click_easyapply = self.driver.find_element_by_xpath("/html/body/div[6]/div[3]/div[3]/section/div/div/div/ul/li[8]/div/button")
    ...
    def find_offers(self): 
        ...
        if total_results_int > 24:
            ...
            find_pages = self.driver.find_elements_by_class_name("artdeco-pagination__pages atdeco-pagination__pages--number")
    ...
    def submit(self,job_ad):
        ...
        #click on apply
        try:
            in_apply = self.driver.find_element_by_xpath("/html/body/div[6]/div[3]/div/div[1]/div[1]/div/div[1]/div/div[2]/div[3]/div/div/div/button")
            in_apply.click()
        ...
        try:
            submit = self.driver.find_element_by_xpath("/html/body/div[3]/div/div/div[2]/div/form/footer/div[3]/button")
